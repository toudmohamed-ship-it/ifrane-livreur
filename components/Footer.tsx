...
import { getWhatsAppLink, PHONE_NUMBER, INSTAGRAM } from "@/lib/schema";
            ...
            <div className={`container ${styles.inner}`}>
                ...
                <div className={styles.brand}>
                    ...
                    <p className={styles.nap}>
                        <strong>Ifrane Livreur</strong><br />
                        Ifrane, Province d&apos;Ifrane, Maroc<br />
                        <a href={`tel:${PHONE_NUMBER.replace(/\s/g, "")}`} className={styles.phone}>{t("phone")}</a>
                    </p>
                </div>
                ...
                <div className={styles.lang}>
                    <p className={styles.langLabel}>Langue / Language / اللغة</p>
                    <div className={styles.langSwitcher}>
                        {locales.map((l) => (
                            <a key={l} href={`/${l}/`} className={`${styles.langBtn} ${l === locale ? styles.langActive : ""}`}>
                                {localeLabels[l]}
                            </a>
                        ))}
                    </div>
